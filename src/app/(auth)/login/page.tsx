  ...
  return (
    <div className="min-h-screen bg-gray-100 text-gray-800 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto">
        <div className="bg-white/30 backdrop-blur-lg border border-gray-200 rounded-2xl shadow-2xl grid lg:grid-cols-2 overflow-hidden">
          ...
          <div className="p-8 md:p-12 bg-white/30 hidden lg:block">
            ...
            <h1 className="text-4xl font-bold tracking-tighter mb-4 text-[#000f7c]">
              Unlock a Universe of Innovation.
            </h1>
            <p className="text-gray-600 mb-8 leading-relaxed">
              Log in to access a world of cutting-edge robotics components. From
              high-torque motors to precision sensors, we provide the building
              blocks for your next great invention.
            </p>
              ...
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">
                    Monitor your shipments from our warehouse to your workshop.
                  </p>
                </div>
              </li>
              <li className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800">
                    Experience Faster Checkout
                  </h3>
                  <p className="text-gray-500 text-sm">
                    Save your details for a seamless purchasing experience.
                  </p>
                </div>
              </li>
              <li className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-500 text-sm">
                    Organize components for future builds and share your ideas.
                  </p>
                </div>
              </li>
            </ul>
